...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: `A PDF-based chat assistant that lets users quickly query documents. Built with LangChain JS, Qdrant, Hugging Face embeddings, Groq LLaMA, BullMQ, Next.js, and Tailwind CSS, it retrieves relevant content from PDFs and generates instant answers.`,
      link: "https://github.com/lavshah19/PDF-Chat-Assistant", // Add live demo link if available
      github: "https://github.com/lavshah19/PDF-Chat-Assistant", // Replace with your repo link
      tech: [
        "Next.js",
        "Tailwind CSS",
        "LangChain JS",
      ...
      image: "/pdfchat.png", // Replace with your project image
      category: "AI / RAG",
    },

    {
      name: "task-arena",
      description:
        "Task Arena is a full-stack productivity web app that makes staying organized fun and competitive. It blends personal task management with challenge-based goal tracking, helping you build better habits, complete tasks, and push your limits.",
          ...
          {projects.map((project, index) => (
            <div
              ...
              className="group relative bg-gradient-to-b from-white/10 to-white/5 
                         ...
                         hover:shadow-2xl hover:shadow-blue-500/10 max-h-[35rem]"
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-20">
                  <div
                    className="inline-flex items-center gap-1.5 bg-black/30 backdrop-blur-md 
              ...
              <div className="p-6">
                <h3
                  className="text-xl font-bold text-white mb-3 group-hover:text-blue-300 
  ...
  {project.description}
              ...
              <div
                className="absolute inset-0 border-2 border-blue-400/10 rounded-2xl opacity-0 
        ...
        <div className="flex justify-center mt-16">
          <div
            className="inline-flex items-center gap-2 text-blue-300/60 
